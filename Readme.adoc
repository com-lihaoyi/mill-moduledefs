...
----
def mvnDeps = Agg(
  mvn"com.lihaoyi::mill-moduledefs:{version}"
)
// Enable the plugin in the Scala compiler
def scalacPluginIvyDeps = Agg(
  mvn"com.lihaoyi:::scalac-mill-moduledefs-plugin:{version}"
)
----
...
_Changes since 0.12.4:_

* Support for Scala 2.13.16, 2.13.17, 2.13.18
